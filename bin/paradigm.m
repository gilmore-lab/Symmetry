...
% history
% 2014-10-26-1656   rogilmore edited
...
% Uses regex to extract file type from file name
% Pattern 1 + 2 digits for symmetry group (1-17) for intact
% (18-34 for phase scrambled) + 2 digits (01-20) indexing specific image
...
% Metadata mapping - for now restrict to p1, p2, p3, p4, p6
