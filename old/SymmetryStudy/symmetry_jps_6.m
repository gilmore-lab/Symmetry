function params = symmetry_jps_6( temp_1 )
temp_1 = 3 

  % close all; clear all; clc; params = symmetry_jps_6( 3 )
...
if(  1  )
       ...
       if(  rand < 0.20  )
        ...
        while(  toc( startKeyPressTimer ) <= 1.25  )
        ...
        end % END - while(  toc( startKeyPressTimer ) <= 1.25  )
        
        responseGripMatrix( tempCounter_2, : ) = [ tempStimulusType, fixationPointChangeFlag, tempKeyPressed, keyPressTime ];
